 ...
 *
 * A full match through the real board UI against the Brutal bot.
 *
...
describe('a full match through the UI', () => {
  it('reaches a decisive result against the Brutal bot with no errors', () => {
    expectDecisiveMatch('brutal');
  });
});
