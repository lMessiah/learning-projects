 ...
 *
 * A full match through the real board UI against the Chaos bot.
 *
...
describe('a full match through the UI', () => {
  it('reaches a decisive result against the Chaos bot with no errors', () => {
    expectDecisiveMatch('chaos');
  });
});
